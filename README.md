...
2.	As a Frequent/Returning Visitor, I want to be able to contact the Japanese embassy with further queries (e.g. visa issues or Covid restrictions etc) about visiting Japan.

## Design

### Colour Scheme
- In line with the Bootstrap dark theme that I used for the Navbar and Footer, I used the colour of the Japanese flag (red and white), while contrasting this with shades of grey, pink, yellow and black. These colours were also used to match the logo that I created for the site. I ensured that these colours contrasted well and would result in good readability for the user. 
...
### Imagery
- The imagery within the website is an important feature for outlining why Japan is a place that people wish to visit. On this basis, the large background hero image on the Home Page of the historic Kyoto skyline, with two figures in traditional dress in the foreground, is designed to be striking and catch the user's attention (see image below), while also highlighting the history of the country. The Enquiries page has five images highlighting the nature (cherry blossom flowers and trees in a forest), people and history (traditional dress and a temple and street in Kyoto) of Japan, while I have included skyline images from the four cities in the Experiences page. 

![optimized-kyoto](https://user-images.githubusercontent.com/71781554/110809589-f1402300-827c-11eb-936f-e455bda72eba.jpg)
![cities-picture](https://user-images.githubusercontent.com/71781554/111145974-d291a300-8580-11eb-8902-9262fdf2027a.png)
...
- Each page in the website features a responsive Bootstrap navigation bar with the site logo featured to the left and the three page links to the right (with the active page highlighted), and these pages also each contain a 4 column Bootstrap footer with a copyright message, address, opening hours and contact information (email and phone). The Homepage features a large hero image, while there are various smaller images inputted in Enquiries and a large Google Map in the Experiences page. Each page has been designed to be intuitive and easy to follow, with text prepared in a concise and to the point structure, and flows in a logical manner from the Home Page to the Enquiries Page:
    ...
    - Enquiries Page: Contact Form accompanied with images of life in Japan (see screenshot below).
...
- I studied the Code Institute lesson on Sending Emails Using EmailJS in order to setup this system, while rearranging the code from the lesson to adapt it to my website (e.g. the recipient of the email was amended to be the user of the site and all of the text within the email template was edited to match the purpose of my site). 
...
- The images used in this project have all been sourced from Unsplash, which is a stock photography site which contains a large catalogue of high-quality free to use images which are not the subject of copyright. The attributions for these images are listed below;
    ...
    - [Experiences Page Tokyo Img - Jezael Melgoza](https://unsplash.com/photos/7H77FWkK_x4)
    - [Experiences Page Kyoto Img - Gio Almonte](https://unsplash.com/photos/8gxxSZUHrEA)
    - [Experiences Page Osaka Img - Nuno Antunes](https://unsplash.com/photos/fceVaAut3Ec)
    - [Experiences Page Sapporo Img - Sen Lee](https://unsplash.com/photos/oM5AZ5keD0I)
